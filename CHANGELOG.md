...
- Native Codex marketplace metadata for `bootstrap-docs` 1.4.1 and `issue-management` 1.0.2
- Native Codex packaging for `implement-lifecycle` 3.2.0
- Portable reviewer skills for correctness, security, architecture, testing, and documentation compliance
...
- Reworked `implement-lifecycle` input handling, task tracking, delegation, and GitHub comment workflows for both Claude Code and Codex
